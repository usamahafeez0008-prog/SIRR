...
class NewOrderInterCityScreen extends StatelessWidget {
                                ...
                                onTap: () async {
                                  if (Constant.selectedMapType == 'osm') {
                                    ...
                                    if (result != null) {
                                      ...
                                      final address = firstPlace.city;
                                      controller.sourceCityController.value.text = address.toString();
                                    }
                                  } else {
                                ...
                                onTap: () async {
                                  if (Constant.selectedMapType == 'osm') {
                                    ...
                                    if (result != null) {
                                      final firstPlace = result;
                                      final address = firstPlace.city;
                                      controller.destinationCityController.value.text = address.toString();
                                    }
                                  } else {
                                    Get.to(const GoogleMapSearchPlacesApi())!.then((value) async {
                                      if (value != null) {
                                                            ...
                                                            Expanded(
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    decoration:
                                                                        BoxDecoration(color: AppColors.lightprimary.withOpacity(0.30), borderRadius: const BorderRadius.all(Radius.circular(5))),
                                                                    child: Padding(
                                                                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
  ...
  Future offerAcceptDialog(BuildContext context, IntercityController controller, InterCityOrderModel orderModel, UserModel userModel) {
